                  ...
                  <div className="w-full md:w-10/12 mt-3">
                    ...
                    <div className="mt-4 md:mt-8">
                      ...
                      <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">
                        Shop 15, Besan street, Santacruz West, Mumbai - 400067
                      </h2>
                    </div>
                    <div className="mt-4 md:mt-8">
                      <h2 className="text-sm md:text-base text-indigo-700 font-semibold">
              ...
              <div className="flex flex-col items-start xl:justify-start 2xl:justify-end xl:px-0 px-4">
                ...
                <div className="w-full 2xl:w-8/12 mt-3">
                  ...
                  <div className="mt-4 md:mt-8">
                    ...
                    <input
                      className="mt-3 text-base border-2 w-11/12 lg:w-full xl:w-10/12 hover:border-indigo-600 focus:border-indigo-600 focus:outline-none border-black py-5 pl-4 text-gray-800 rounded-2xl"
                      type="text"
                  ...
                  <div className="mt-4 md:mt-8">
                    ...
                    <textarea
                      className="mt-3 text-base border-2 w-11/12 lg:w-full xl:w-10/12 resize-none hover:border-indigo-600 focus:border-indigo-600 focus:outline-none border-black xl:h-40 py-5 pl-4 text-gray-800 rounded-2xl"
                      type="text"
                  ...
                  <div className="py-5">
                    <button className="py-3 md:py-5 px-5 md:px-10 bg-gray-900 text-white hover:opacity-90 ease-in duration-150 text-sm md:text-lg tracking-wider font-semibold rounded-2xl">
                      Send
                    </button>
                  </div>
                </div>
